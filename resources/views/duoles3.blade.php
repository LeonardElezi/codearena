...
<div id="app" class="player lesson known leave-warning translate"><div class="player-inner"><section class="player-container slide-in"><div id="context-view"></div><header class="player-header dynamic "><ul class="player-header-left" style=""><li id="explanation"><div class="tips-and-notes">Tips &amp; notes</div><div class="popover below popover-tips-and-notes"><div class="arrow-top-small-container"><div class="arrow"></div></div><div class="close"></div><div class="inner"><div class="content"><h3>Welkom!</h3>
                                    ...
                                    <p>The Dutch alphabet has 26 letters – just like in English. In fact, you don’t have to learn any new letters! Hurrah! <br>
                                        However, there are a lot of differences and peculiarities in pronunciation. Some letters are pronounced differently, and there can be combinations of letters that may throw you for a loop. Don’t worry, we are not discussing the letters just now.</p></div></div></div></li></ul><ul class="player-header-right"><li><a class="player-quit" style="cursor:pointer;" id="quit-button">Quit</a></li></ul><div class="progress-bar-container"><div id="progress-bar"><span class="progress-bar-container-inner"><span class="progress-bar-dynamic left strength-bar"><div class="bar blue" style="opacity: 1; width: 42.8571%;"><div class="bubbles" style="display: block;"></div><div class="triangle-end" style="display: block;"></div></div><div class="skill-icon-container"><div class="challenge-number-container"><span class="challenge-num">4</span><span class="challenge-num-circle white"></span><span class="challenge-num-backing"></span></div><span class="skill-icon smaller locked white" style="position: absolute;"><span class="skill-icon-image skill-icon-1"></span></span><span class="skill-icon smaller blue unlocked finished-skill bounce-in hidden"><span class="skill-icon-image skill-icon-1"></span></span></div><span class="backing"></span></span></span> </div></div></header> <div class="player-main"><div id="prev-session-element-container" class=""></div><div id="session-element-container" class=""><div class="challenge-translate"><h1 class="player">Translate this text</h1><div class="challenge-row"><div class="challenge-cell"><div class="text-to-translate"><span id="big-speaker"><span id="speaker-audio-10-button" class="speaker-small" style="margin-right: 20px"><span class="icon icon-speaker-small "></span></span><div id="speaker-audio-10" src="https://d7mj4aqfscim2.cloudfront.net/tts/{voice}/sentence/b878fba57d1202337b228c56ccaa3487" class="hidden"></div> </span><bdi><span class="hints translation-source"><span><bdi><span class="hints-sentence popover-well" style="position: relative;"><span><span class="token-wrapper popover-wrapper"><span class=" non-space token   " id="token_0" data-token-index="0">Een</span><span class="hint-table hint-popover below "><div class="inner "><div class="content"><table><thead><tr></tr></thead><tbody><tr><td>a </td></tr><tr><td>an </td></tr></tbody></table></div></div></span></span></span><span><span class="token-wrapper popover-wrapper"><span class="space  token   " id="token_" data-token-index=""> </span></span></span><span><span class="token-wrapper popover-wrapper"><span class=" non-space token   " id="token_1" data-token-index="1">man</span><span class="hint-table hint-popover below "><div class="inner "><div class="content"><table><thead><tr></tr></thead><tbody><tr><td>man </td></tr><tr><td>male </td></tr><tr><td>husband </td></tr></tbody></table></div></div></span></span></span></span></bdi> </span></span></bdi></div></div><div class="challenge-cell"><div class="relative"><span class="icon icon-arrow-blue-right "></span><div id="blame-1" class="popover above blame-popover animated slide-in"><div class="inner"><div class="icon-warning"></div></div></div> </div><textarea placeholder="Type in English" class="textarea-block textarea-lg textarea-translate" id="text-input" name="text-input" lang="en" tabindex="1" dir="auto" style="overflow: hidden; word-wrap: break-word; resize: none; height: 100px;"></textarea><div id="submitted-text"></div><div id="vkeyboard-placeholder" style="display: none;"></div></div></div></div> </div><div class="intro"></div></div><footer id="controls" class="player-footer " style="display: block;"><div class="col-right "><span class="more-padding-left"><button id="next_button" type="submit" data-toggle="tooltip" title="" class="btn btn-green btn-lg has-tooltip redesign-check" data-margin="5" tabindex="20" data-delay="{&quot;show&quot;:&quot;100&quot;, &quot;hide&quot;: &quot;0&quot;}" data-original-title="Press Enter to Check" disabled="disabled">Check</button></span></div><div class="col-left"><button id="skip_button" style="border-color: rgb(204, 204, 204); display: block;" class=" btn btn-outline btn-standard btn-lg left skip-margin skip-button" tabindex="30">Skip</button><button id="no-mic-link" style="display: none;" type="submit" class="btn btn-lg btn-white left skip-margin" tabindex="10">I don't want to use a microphone</button><div id="grade"> </div></div></footer><div id="no-sound-modal" class="modal hidden fade" style="margin-top: -200px;"><div class="modal-header"><h4>We can't play sound in your browser.</h4><div class="close" data-dismiss="modal">close</div></div><div class="modal-body"></div></div><div id="modal-notification" class="modal hidden fade"></div></section></div><div class="footer-main"><ul class="nav-footer"><li><a href="https://www.duolingo.com/info" tabindex="100">About</a></li><li><a href="https://englishtest.duolingo.com/" tabindex="102">Duolingo English Test</a></li><li class="mobile-hidden"><a href="https://www.duolingo.com/mobile" tabindex="103">Mobile</a></li><li class="mobile-hidden"><a href="http://gear.duolingo.com/" tabindex="104" target="_blank">Gear</a></li><li class="mobile-hidden"><a href="https://www.duolingo.com/help" tabindex="105">Help</a></li><li class="mobile-hidden"><a href="https://www.duolingo.com/guidelines" tabindex="106">Guidelines</a></li><li><a href="https://www.duolingo.com/jobs" tabindex="107">Jobs</a></li><li class="mobile-hidden"><a href="https://www.duolingo.com/terms" tabindex="108">Terms</a></li><li class="mobile-hidden"><a href="https://www.duolingo.com/privacy" tabindex="109">Privacy</a></li><li class="mobile-hidden"><a href="http://twitter.com/duolingo" tabindex="130"><span class="icon icon-twitter-small"></span></a></li><li class="mobile-hidden"><a href="http://facebook.com/duolingo" tabindex="140"><span class="icon icon-fb-small"></span></a></li><span class="social-footer"><li><a href="http://twitter.com/duolingo" tabindex="130"><span class="icon icon-twitter-small"></span></a></li><li><a href="http://facebook.com/duolingo" tabindex="140"><span class="icon icon-fb-small"></span></a></li></span></ul></div>  </div>
