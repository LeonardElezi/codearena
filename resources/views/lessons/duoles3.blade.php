@extends('layouts.duo')
@section('app')
    <div id="app" class="player lesson known leave-warning translate">
            ...
            <section class="player-container slide-in">
                    ...
                    <div class="progress-bar-container">
                        <div id="progress-bar"><span class="progress-bar-container-inner"><span
                                        class="progress-bar-dynamic left strength-bar"><div class="bar blue"
                                                                                            style="opacity: 1; width: 42.8571%;"><div
                                            ...
                                            class="skill-icon-container"><div class="challenge-number-container"><span
                                                    class="challenge-num">4</span><span
                ...
                <div class="player-main">
                    ...
                    <div id="session-element-container" class="">
                        <div class="challenge-translate"><h1 class="player">Translate this text</h1>
                            <div class="challenge-row">
                                <div class="challenge-cell">
                                    <div class="text-to-translate"><span id="big-speaker"><span
                                                    id="speaker-audio-10-button" class="speaker-small"
                                                    style="margin-right: 20px"><span
                                                        class="icon icon-speaker-small "></span></span><div
                                                    id="speaker-audio-10"
                                                    src="https://d7mj4aqfscim2.cloudfront.net/tts/{voice}/sentence/b878fba57d1202337b228c56ccaa3487"
                                                    class="hidden"></div> </span>
                                        <bdi><span class="hints translation-source"><span><bdi><span
                                                                class="hints-sentence popover-well"
                                                                style="position: relative;"><span><span
                                                                        class="token-wrapper popover-wrapper"><span
                                                                            class=" non-space token   " id="token_0"
                                                                            data-token-index="0">Een</span><span
                                                                            class="hint-table hint-popover below "><div
                                                                                class="inner "><div class="content"><table><thead><tr></tr></thead><tbody><tr><td>a </td></tr><tr><td>an </td></tr></tbody></table></div></div></span></span></span><span><span
                                                                        class="token-wrapper popover-wrapper"><span
                                                                            class="space  token   " id="token_"
                                                                            data-token-index=""> </span></span></span><span><span
                                                                        class="token-wrapper popover-wrapper"><span
                                                                            class=" non-space token   " id="token_1"
                                                                            data-token-index="1">man</span><span
                                                                            class="hint-table hint-popover below "><div
                                                                                class="inner "><div class="content"><table><thead><tr></tr></thead><tbody><tr><td>man </td></tr><tr><td>male </td></tr><tr><td>husband </td></tr></tbody></table></div></div></span></span></span></span></bdi> </span></span>
                                        </bdi>
                                    </div>
                                </div>
                                <div class="challenge-cell">
                                    <div class="relative"><span class="icon icon-arrow-blue-right "></span>
                                    ...
                                    <textarea placeholder="Type in English"
                                              class="textarea-block textarea-lg textarea-translate" id="text-input"
                                              name="text-input" lang="en" tabindex="1" dir="auto"
                                              style="overflow: hidden; word-wrap: break-word; resize: none; height: 100px;"></textarea>
                                    <div id="submitted-text"></div>
                                    <div id="vkeyboard-placeholder" style="display: none;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
