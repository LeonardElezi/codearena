@extends('layouts.duo')
@section('app')
    <div id="app" class="player lesson select known">
        <div class="player-inner">
            <section class="player-container slide-in">
                    ...
                    <div class="progress-bar-container">
                        <div id="progress-bar"><span class="progress-bar-container-inner"><span
                                        class="progress-bar-dynamic left strength-bar"><div class="bar blue"
                                                ...
                                                class="bubbles"></div><div class="triangle-end"></div></div><div
                                            class="skill-icon-container"><div class="challenge-number-container"><span
                                                    class="challenge-num">1</span><span
                ...
                <div class="player-main">
                    ...
                    <div id="session-element-container">
                        <div class="challenge-select"><h1 class="player">Select translation of “the woman”</h1>
                            <bdi>
                                <ul class="select-images select-images-list hover-effect">
                                    <li id="option-1" data-toggle="tooltip" title="" data-margin="5"
                                        data-delay="{&quot;show&quot;:&quot;100&quot;, &quot;hide&quot;: &quot;0&quot;}"
                                        data-original-title="Press 1 to Select"><label>
                                            <div class="select-images-frame"
                                                 style="background-image: url(&#39;https://d2pur3iezf4d1j.cloudfront.net/images/e106ab77de9f69b3fd62b1e4974383b0&#39;)"></div>
                                            <span class="number">1</span><input type="radio" class="player-radio"
                                                                                name="selection" value="het meisje"
                                                                                data-number="1"><span class="title">het meisje</span></label>
                                    </li>
                                    <li id="option-2" data-toggle="tooltip" title="Press 2 to Select" data-margin="5"
                                        data-delay="{&quot;show&quot;:&quot;100&quot;, &quot;hide&quot;: &quot;0&quot;}">
                                        <label>
                                            <div class="select-images-frame"
                                                 style="background-image: url(&#39;https://d2pur3iezf4d1j.cloudfront.net/images/7d79a087d3318fd6d4a750bde620ccd7&#39;)"></div>
                                            <span class="number">2</span><input type="radio" class="player-radio"
                                                                                name="selection" value="het kind"
                                                                                data-number="2"><span class="title">het kind</span></label>
                                    </li>
                                    <li id="option-3" data-toggle="tooltip" title="Press 3 to Select" data-margin="5"
                                        data-delay="{&quot;show&quot;:&quot;100&quot;, &quot;hide&quot;: &quot;0&quot;}">
                                        <label>
                                            <div class="select-images-frame"
                                                 style="background-image: url(&#39;https://d2pur3iezf4d1j.cloudfront.net/images/cfd6ac49dca2c518ce9da14a23347092&#39;)"></div>
                                            <span class="number">3</span><input type="radio" class="player-radio"
                                                                                name="selection" value="de vrouw"
                                                                                data-number="3"><span class="title">de vrouw</span></label>
                                    </li>
                                </ul>
                            </bdi>
                        </div>
                        <div id="speaker-1"></div>
                        <div id="speaker-2"></div>
                        <div id="speaker-3"></div>
                    </div>
                    <div class="intro"></div>
                </div>
                <footer id="controls" class="player-footer " style="display: block;">
                    <div class="col-right "><span class="more-padding-left"><button id="next_button" type="submit"
                                                                                    ...
                                                                                    data-delay="{&quot;show&quot;:&quot;100&quot;, &quot;hide&quot;: &quot;0&quot;}"
                                                                                    data-original-title="Press Enter to Check"
                                                                                    disabled="disabled">Check</button></span>
                    </div>
                    <div class="col-left">
                        <button id="skip_button" style="border-color: #CCCCCC;"
